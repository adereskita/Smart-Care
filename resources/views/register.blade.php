...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}">
        ...
        <title>Register | Smart Care</title>
                ...
                <fieldset id="field-form" class="uk-fieldset uk-width-large uk-padding">
                    ...
                    <div class="uk-margin">
                        <div class="uk-inline uk-width-large">
                            ...
                            <input id="nama" class="uk-input" name="name" type="text" placeholder="Name">
                        </div>
                    </div>
                    <!-- EMAIL -->
                    <div class="uk-margin">
                        <div class="uk-inline uk-width-large">
                            ...
                            <input id="email" class="uk-input" name="email" type="email" placeholder="Email">
                        </div>
                    </div>
                    <!-- PASSWORD -->
                    <div class="uk-margin">
                        <div class="uk-inline uk-width-large">
                            ...
                            <input id="password" class="uk-input" name="password" type="password" placeholder="Password">
                        </div>
                    </div>
